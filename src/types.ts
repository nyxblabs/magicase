...
type SameLetterCase<
  X extends string, Y extends string,
...
type CapitalizedWords<
  T extends readonly string[], Accumulator extends string = '',
> = T extends readonly [infer F extends string, ...infer R extends string[]]
   ? CapitalizedWords<R, `${Accumulator}${Capitalize<F>}`>
   : Accumulator
type JoinLowercaseWords<
  T extends readonly string[], Joiner extends string, Accumulator extends string = '',
> = T extends readonly [infer F extends string, ...infer R extends string[]]
   ? Accumulator extends ''
...
export type SplitByCase<
  T, Separator extends string = Splitter, Accumulator extends unknown[] = [],
