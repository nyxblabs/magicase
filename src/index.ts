import type { CamelCase, JoinByCase, PascalCase, SplitByCase } from './types'
...
export function splitByCase<
  T extends string, Separator extends readonly string[],
...
export function kebabCase<
  T extends string | readonly string[], Joiner extends string,
